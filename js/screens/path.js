...
export async function mountPath() {
  ...
  async function render() {
    ...
    todosHost.appendChild(
      el("div", { class: "col" }, [
        ...
        el("div", { class: "meta" }, "To-Do’s come from Journal. You can complete them here."),
    ...
    calHost.appendChild(
      el("div", { class: "col" }, [
        ...
        blocks.length === 0
          ? el("div", { class: "meta" }, "No blocks yet. Add in Mindset → Calendar or below.")
          : el("div", { class: "list" }, blocks.map((b) =>
              el("div", { class: "card" }, `${b.start}–${b.end} · ${b.title}`)
            )),
        el("div", { class: "divider" }),
        el("div", { class: "row" }, [
    ...
    tplHost.appendChild(
      el("div", { class: "col" }, [
        el("div", { class: "meta" }, "Templates are user-defined. Apply template adds its blocks to today (does not delete existing blocks)."),
        templates.length === 0
              ...
              el("div", { class: "card col" }, [
                ...
                el("div", { class: "row" }, [
                  el("button", {
                    class: "btn primary",
                    onclick: async () => {
                      await db.applyTemplateToDate(t, date);
                      await render();
                    }
                  }, "Apply to Today"),
                  el("button", {
